...
6. The INFO column of an output VCF contains two fields, Tumor_AD (Tumor allelic fraction) and Tumor_DP (Tumor depth) and both of them are retrieved from individual VCFs accoring to above priority order, e.g., "Tumor_AF=0.25;Tumor_DP=26;" in the INFO column.
